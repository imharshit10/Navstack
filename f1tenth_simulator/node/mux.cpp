...
public:
    Mux() {
        ...
        int sdc_mux_idx;
        std::string sdc_drive_topic;
        n.getParam("sdc_drive_topic", sdc_drive_topic);
        n.getParam("sdc_mux_idx", sdc_mux_idx);
        add_channel(sdc_drive_topic , drive_topic, sdc_mux_idx);
